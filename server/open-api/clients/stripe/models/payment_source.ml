...
let create (country : string option) (created : int32) (id : string)
    (_object : Enums.source_object) (_type : Enums.type_2)
    (fingerprint : string option) (livemode : bool) (reusable : bool)
    (used : bool) (username : string) (currency : string option)
    (last4 : string) (status : string) (active : bool) (amount : int32 option)
    (amount_received : int32) (bitcoin_amount : int32)
    (bitcoin_amount_received : int32) (bitcoin_uri : string) (filled : bool)
    (inbound_address : string) (uncaptured_funds : bool) (brand : string)
    (exp_month : int32) (exp_year : int32) (funding : string)
    (client_secret : string) (flow : string) : t =
  {
