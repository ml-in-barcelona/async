...
type t = {
  ...
  customer_balance_transaction :
    Any_ofstringcustomer_balance_transaction.t option;
      [@default None]
...
let create (amount : int32) (created : int32) (currency : string)
    (customer : Any_ofstringcustomerdeleted_customer.t)
    (discount_amount : int32)
    (discount_amounts : Discounts_resource_discount_amount.t list) (id : string)
    (invoice : Any_ofstringinvoice.t) (lines : Credit_note_lines_list_1.t)
    (livemode : bool) (number : string) (_object : Enums.credit_note_object)
    (pdf : string) (status : Enums.credit_note_status) (subtotal : int32)
    (tax_amounts : Credit_note_tax_amount.t list) (total : int32)
    (_type : Enums.credit_note_type) : t =
  {
    amount;
    created;
    currency;
