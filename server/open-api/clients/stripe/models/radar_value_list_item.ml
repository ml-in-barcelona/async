...
type t = {
  ...
  _object : Enums.deleted_radar_value_list_item_object;
      [@default `RadarPeriodvalue_list_item]
...
let create (created : int32) (created_by : string) (id : string)
    (livemode : bool) (_object : Enums.deleted_radar_value_list_item_object)
    (value : string) (value_list : string) : t =
  { created; created_by; id; livemode; _object; value; value_list }
