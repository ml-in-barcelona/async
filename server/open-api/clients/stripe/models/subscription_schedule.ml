...
type t = {
  ...
  current_phase : Any_ofsubscription_schedule_current_phase.t option;
      [@default None]
  ...
  _object : Enums.subscription_schedule_object;
...
let create (created : int32) (customer : Any_ofstringcustomerdeleted_customer.t)
    (default_settings : Subscription_schedules_resource_default_settings.t)
    (end_behavior : Enums.end_behavior) (id : string) (livemode : bool)
    (_object : Enums.subscription_schedule_object)
    (phases : Subscription_schedule_phase_configuration.t list)
    (status : Enums.subscription_schedule_status) : t =
  {
    canceled_at = None;
    completed_at = None;
    created;
