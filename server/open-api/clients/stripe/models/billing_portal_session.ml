...
type t = {
  ...
  _object : Enums.billing_portal_session_object;
      [@default `Billing_portalPeriodsession]
...
let create (created : int32) (customer : string) (id : string) (livemode : bool)
    (_object : Enums.billing_portal_session_object) (return_url : string)
    (url : string) : t =
  { created; customer; id; livemode; _object; return_url; url }
