...
type t = {
  acss_debit : Source_mandate_notification_acss_debit_data.t option;
      [@default None]
  (* A positive integer in the smallest currency unit (that is, 100 cents for $1.00, or 1 for ¥1, Japanese Yen being a zero-decimal currency) representing the amount associated with the mandate notification. The amount is expressed in the currency of the underlying source. Required if the notification type is `debit_initiated`. *)
  amount : int32 option; [@default None]
  bacs_debit : Source_mandate_notification_bacs_debit_data.t option;
      [@default None]
  ...
  _object : Enums.source_mandate_notification_object;
      [@default `Source_mandate_notification]
  (* The reason of the mandate notification. Valid reasons are `mandate_confirmed` or `debit_initiated`. *)
  reason : string;
  sepa_debit : Source_mandate_notification_sepa_debit_data.t option;
      [@default None]
  source : Source.t;
...
let create (created : int32) (id : string) (livemode : bool)
    (_object : Enums.source_mandate_notification_object) (reason : string)
    (source : Source.t) (status : string) (_type : string) : t =
  {
    acss_debit = None;
    amount = None;
    bacs_debit = None;
