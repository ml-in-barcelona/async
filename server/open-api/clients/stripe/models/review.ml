...
type t = {
  ...
  ip_address_location : Any_ofradar_review_resource_location.t option;
      [@default None]
...
let create (created : int32) (id : string) (livemode : bool)
    (_object : Enums.review_object) (_open : bool)
    (opened_reason : Enums.opened_reason) (reason : string) : t =
  {
    billing_zip = None;
    charge = None;
    closed_reason = None;
