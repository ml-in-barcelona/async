...
let create (active : bool) (amount : int32) (amount_received : int32)
    (bitcoin_amount : int32) (bitcoin_amount_received : int32)
    (bitcoin_uri : string) (created : int32) (currency : string) (filled : bool)
    (id : string) (inbound_address : string) (livemode : bool)
    (_object : Enums.bitcoin_receiver_object) (uncaptured_funds : bool) : t =
  {
    active;
    amount;
    amount_received;
