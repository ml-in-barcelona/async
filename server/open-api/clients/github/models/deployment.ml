...
let create (url : string) (id : int32) (node_id : string) (sha : string)
    (ref : string) (task : string) (payload : Yojson.Safe.t)
    (environment : string) (description : string option)
    (creator : Simple_user.t option) (created_at : string) (updated_at : string)
    (statuses_url : string) (repository_url : string) : t =
  {
    url;
    id;
    node_id;
