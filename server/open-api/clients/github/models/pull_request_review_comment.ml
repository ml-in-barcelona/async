...
let create (url : string) (pull_request_review_id : int32 option) (id : int32)
    (node_id : string) (diff_hunk : string) (path : string) (position : int32)
    (original_position : int32) (commit_id : string)
    (original_commit_id : string) (user : Simple_user.t option) (body : string)
    (created_at : string) (updated_at : string) (html_url : string)
    (pull_request_url : string) (author_association : string)
    (_links : Pull_request_review_comment__links.t) : t =
  {
    url;
