...
let create (id : int32) (node_id : string) (owner : Simple_user.t option) (name : string) (description : string option) (external_url : string) (html_url : string) (created_at : string) (updated_at : string) (permissions : (string * string) list) (events : string list) : t = {
    id = id;
    slug = None;
    node_id = node_id;
    owner = owner;
