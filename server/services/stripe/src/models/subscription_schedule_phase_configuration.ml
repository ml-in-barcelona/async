...
let create (add_invoice_items : Subscription_schedule_add_invoice_item.t list) (end_date : int32) (items : Subscription_schedule_configuration_item.t list) (proration_behavior : Enums.proration_behavior) (start_date : int32) : t = {
