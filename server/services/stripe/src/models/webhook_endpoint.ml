...
let create (created : int32) (enabled_events : string list) (id : string) (livemode : bool) (metadata : (string * string) list) (_object : Enums.deleted_webhook_endpoint_object) (status : string) (url : string) : t = {
    api_version = None;
    application = None;
    created = created;
    description = None;
