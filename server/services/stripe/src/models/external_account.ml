...
let create (country : string option) (currency : string option) (id : string) (last4 : string) (_object : Enums.card_object) (status : string) (brand : string) (exp_month : int32) (exp_year : int32) (funding : string) : t = {
    account = None;
