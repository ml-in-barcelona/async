...
type t = {
    ...
    masterpass: Payment_method_details_card_wallet_masterpass.t option [@default None];
    ...
    visa_checkout: Payment_method_details_card_wallet_visa_checkout.t option [@default None];
