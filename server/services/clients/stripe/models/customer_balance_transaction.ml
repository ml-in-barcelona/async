...
type t = {
  ...
  _object : Enums.customer_balance_transaction_object;
      [@default `Customer_balance_transaction]
...
let create (amount : int32) (created : int32) (currency : string)
    (customer : Any_ofstringcustomer.t) (ending_balance : int32) (id : string)
    (livemode : bool) (_object : Enums.customer_balance_transaction_object)
    (_type : Enums.customer_balance_transaction_type) : t =
  {
    amount;
    created;
    credit_note = None;
