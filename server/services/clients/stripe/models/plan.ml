...
let create (active : bool) (billing_scheme : Enums.billing_scheme)
    (created : int32) (currency : string) (id : string)
    (interval : Enums.interval) (interval_count : int32) (livemode : bool)
    (_object : Enums.deleted_plan_object) (usage_type : Enums.usage_type) : t =
  {
    active;
