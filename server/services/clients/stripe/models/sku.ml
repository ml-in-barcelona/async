...
let create (active : bool) (attributes : (string * string) list)
    (created : int32) (currency : string) (id : string)
    (inventory : Inventory.t) (livemode : bool)
    (metadata : (string * string) list) (_object : Enums.deleted_sku_object)
    (price : int32) (product : Any_ofstringproduct.t) (updated : int32) : t =
  {
    active;
    attributes;
    created;
