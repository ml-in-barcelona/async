...
let create (amount_due : int32) (amount_paid : int32) (amount_remaining : int32)
    (attempt_count : int32) (attempted : bool) (created : int32)
    (currency : string) (customer : Any_ofstringcustomerdeleted_customer.t)
    (default_tax_rates : Tax_rate.t list) (lines : Invoice_lines_list_1.t)
    (livemode : bool) (_object : Enums.deleted_invoice_object) (paid : bool)
    (period_end : int32) (period_start : int32)
    (post_payment_credit_notes_amount : int32)
    (pre_payment_credit_notes_amount : int32) (starting_balance : int32)
    (status_transitions : Invoices_status_transitions.t) (subtotal : int32)
    (total : int32) (total_tax_amounts : Invoice_tax_amount.t list) : t =
  {
