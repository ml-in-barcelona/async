...
type t = {
  ...
  _object : Enums.deleted_terminal_location_object;
      [@default `TerminalPeriodlocation]
}
...
let create (address : Address.t) (display_name : string) (id : string)
    (livemode : bool) (metadata : (string * string) list)
    (_object : Enums.deleted_terminal_location_object) : t =
  { address; display_name; id; livemode; metadata; _object }
