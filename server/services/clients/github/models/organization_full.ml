...
let create (login : string) (id : int32) (node_id : string) (url : string)
    ...
    (avatar_url : string) (description : string option)
    (has_organization_projects : bool) (has_repository_projects : bool)
    (public_repos : int32) (public_gists : int32) (followers : int32)
    (following : int32) (html_url : string) (created_at : string)
    (_type : string) (updated_at : string) : t =
  {
    login;
    id;
    node_id;
